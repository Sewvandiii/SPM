 ...
 * @author Thili
 */
public class update_tags extends javax.swing.JFrame {

    /**
     * Creates new form update_tags
     */
    public update_tags() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(update_tags.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new update_tags().setVisible(true);
            }
        });
    }
